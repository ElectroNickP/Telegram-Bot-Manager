...
from src.adapters.telegram.aiogram_adapter import AiogramTelegramAdapter
from src.adapters.storage.json_adapter import JsonConfigStorageAdapter
from src.adapters.updater.git_adapter import GitAutoUpdaterAdapter

from src.core.domain.bot import Bot, BotConfig, BotStatus
from src.core.domain.conversation import Conversation, ConversationKey, Message
