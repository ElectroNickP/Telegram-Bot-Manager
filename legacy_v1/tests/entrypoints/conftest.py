...
from src.core.entrypoints.factories import UseCaseFactory, EntryPointFactory
from src.core.entrypoints.config import EntryPointConfig
...
def web_client(test_config: EntryPointConfig, entry_point_factory: EntryPointFactory):
    ...
    from src.core.entrypoints.web.flask_app import create_app
...
def api_client(test_config: EntryPointConfig, entry_point_factory: EntryPointFactory):
    ...
    from src.core.entrypoints.api.api_app import create_app
